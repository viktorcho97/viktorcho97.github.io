function startApp() {
    ...
    function showHideMenuLinks() { // да показва правилните връзки
        $('#linkHome').show();
    ...
    function showView(viewName) { //когато се зареди прилож. да показва екрана
        $('main > section').hide();
        $('#' + viewName).show();
    }
    ...
    function showLoginView() {
        showView('viewLogin');
        $('#formLogin').trigger('reset'); //презареждане на формуляра
    }
    ...
    function showInfo(message) { //показва че сме успешно влезли и изчезва след 3 сек.
    ...
    function listBooks() { //ще добавяме вече към добавените книги
        $('#books').empty();
        showView('viewBooks');
